...
export const Hero = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_78%,transparent)] lg:rounded-full lg:bg-[radial-gradient(60%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_60%,transparent)]" />
      ...
      <div className="container relative mt-16">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          Elevate yout {"site's"} visibility effortlessly with AI, where smart
